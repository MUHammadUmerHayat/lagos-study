angular.module('app.controller', [])
  .controller('OpenAndelaCtrl', ['$scope', '$timeout', function($scope, $timeout) {
    ...
    $scope.application_process = [
      ...
      { id: 2, stage: "STAGE 3: 11 Weeks Training ", process: "Successful applicants participate in an eleven-week, full-time training in our facilities." }
    ];
    ...
    var deadline = new Date("Wed May 18 2016 23:59:59 GMT+0100 (WAT)");
